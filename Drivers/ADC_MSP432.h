...
//--------------------------------------------------------------------------------------------------------------------------------------------------------
// Funcion que inicializa el módulo con una resolucion de 8 bits
extern void InicializarADC8(uint32_t CLK_div);
// Funcion que inicializa el módulo con una resolucion de 10 bits
void InicializarADC10(uint32_t CLK_div);
// Funcion que inicializa el módulo con una resolucion de 12 bits
void InicializarADC12(uint32_t CLK_div);
// Funcion que inicializa el módulo con una resolucion de 14 bits
extern void InicializarADC14(uint32_t CLK_div);
//Función que configura el modo de conversion del módulo ADC
extern void ModoConversionADC(uint32_t ConvertionMode);
//Función que configura el canal inicial y final del módulo ADC
extern void CanalesADC(uint32_t CH, uint32_t CH1);
//Función que dispara la conversión ADC e indica si hay una conversión en curso o no
extern void DisparoADC(void);
//Función para obtener el valor de la conversión ADC de un canal
